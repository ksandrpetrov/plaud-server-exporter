...
function printUsage() {
  process.stdout.write(
    [
      ...
      "    --playwright        Snapshot login via Playwright (session.json). Required",
      "                        for Plaud folder mirroring — the official API has no",
      "                        filetag endpoint, so OAuth alone gives a flat vault.",
      ...
      "                      and reports every sync. Requires TELEGRAM_BOT_TOKEN plus",
      "                      TELEGRAM_ALLOWED_USER_ID (recommended) and/or",
