...
const BOT_FEATURES_BLOCK =
  ...
  "📁 открыть дерево записей и прочитать саммари по номеру\n" +
  "⚙️ настроить расписание автосинка";

const TREE_PICK_TIP =
  "Открой папку в <b>Дереве записей</b> — у каждой записи будет номер. " +
  "Отправь цифру (1–30 на странице), чтобы прочитать саммари в чате.";
...
export const BOT_HELP_RICH_MARKDOWN =
  ...
  "/status — статус последнего синка\n" +
  "/help — справка\n\n" +
  "<details>\n<summary>Как прочитать саммари</summary>\n\n" +
  "Открой папку в **Дереве записей** — у каждой записи будет номер. " +
  "Отправь цифру (1–30 на странице), чтобы открыть саммари прямо в чате. " +
  "Если саммари ещё нет на сервере, я сначала синхронизирую его.\n\n" +
  "</details>";
